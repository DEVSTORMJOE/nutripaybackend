...
const { getAssignedDeliveries, confirmPickup, markDelivered, getDeliveryHistory } = require('../controllers/deliveryController');
...
router.put('/pickup/:id', protect, role('delivery'), confirmPickup);
